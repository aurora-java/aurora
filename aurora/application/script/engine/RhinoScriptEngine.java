...
public final class RhinoScriptEngine extends AbstractScriptEngine implements
	 ...
	 * == 0) { System.out.println("No file specified"); return; }
	 * 
	 * InputStreamReader r = new InputStreamReader(new
	 * FileInputStream(args[0])); ScriptEngine engine = new RhinoScriptEngine();
	 * 
	 * engine.put("x", "y"); engine.put(ScriptEngine.FILENAME, args[0]);
	 * engine.eval(r); System.out.println(engine.get("x")); }
	 */
}