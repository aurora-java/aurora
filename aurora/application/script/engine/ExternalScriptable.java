 ...
 * 
 * import org.mozilla.javascript.Context; import
 * org.mozilla.javascript.Function; import
 * org.mozilla.javascript.NativeJavaClass; import
 * org.mozilla.javascript.ScriptRuntime; import
 * org.mozilla.javascript.Scriptable; import
 * org.mozilla.javascript.ScriptableObject; import
 * org.mozilla.javascript.Wrapper;
 * 
 * import aurora.application.script.Bindings; import
 * aurora.application.script.ScriptContext; ike Grogan
 * 
...
final class ExternalScriptable implements Scriptable {
	/*
	 * Underlying ScriptContext that we use to store named variables of this
	 * scope.
	 */
	private ScriptContext context;

	/*
	 * JavaScript allows variables to be named as numbers (indexed properties).
	 * This way arrays, objects (scopes) are treated uniformly. Note that JSR
	 * 223 API supports only String named variables and so we can't store these
	 * in Bindings. Also, JavaScript allows name of the property name to be even
	 * empty String! Again, JSR 223 API does not support empty name. So, we use
	 * the following fallback map to store such variables of this scope. This
	 * map is not exposed to JSR 223 API. We can just script objects "as is" and
	 * need not convert.
	 */
	...
	private Object jsToJava(Object jsObj) {
		if (jsObj instanceof Wrapper) {
			...
			/*
			 * importClass feature of ImporterTopLevel puts NativeJavaClass in
			 * global scope. If we unwrap it, importClass won't work.
			 */
			...
			/*
			 * script may use Java primitive wrapper type objects (such as
			 * java.lang.Integer, java.lang.Boolean etc) explicitly. If we
			 * unwrap, then these script objects will become script primitive
			 * types. For example,
			 * 
