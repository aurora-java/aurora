...
package aurora.application.script;
 ...
 * the Manager. This class uses the <a
 ...
 * <br>
 * The <code>ScriptEngineManager</code> provides a method to return an array of
...
public class ScriptEngineManager {
	 ...
	 * . Otherwise, the effect is the same as calling
	 * <code>ScriptEngineManager(null)</code>.
	 * 
	 ...
	 * <code>ClassLoader</code> using the <a
	 * href="../../../technotes/guides/jar/jar.html#Service%20Provider">service
	 * provider</a> mechanism.<br>
	 * <br>
	...
	/**
	 * Returns an array whose elements are instances of all the
