...
//	public static final String PROPERTITY_EVENT_HANDLER = "handler";
    ...
    public void setPrompt(String prompt){
        putString(PROPERTITY_LABEL, prompt);
    }
...
//    public CompositeMap addEvent(String name, String handler) {
//    	CompositeMap events = getEvents();
//    	CompositeMap event = new CompositeMap(PROPERTITY_EVENT);
//    	event.putString(PROPERTITY_EVENT_NAME, name);
//    	event.putString(PROPERTITY_EVENT_HANDLER, handler);
